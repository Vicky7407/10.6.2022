                            ...
                            <div className="col-lg-3">
                                <ul className="nav nav-tabs flex-column">
                                    <li className="nav-item">
                                        <NavLink to="/" className="nav-link active show" data-bs-toggle="tab" href="#tab-1">E.N.T</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/" className="nav-link" data-bs-toggle="tab" href="#tab-2">Cancer</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/" className="nav-link" data-bs-toggle="tab" href="#tab-3">Physiotherapy</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/" className="nav-link" data-bs-toggle="tab" href="#tab-4">Dental</NavLink>
                                    </li>
                                    <li className="nav-item">
                                        <NavLink to="/" className="nav-link" data-bs-toggle="tab" href="#tab-5">Neurosurgery</NavLink>
                                    </li>
                                </ul>
                            </div>
